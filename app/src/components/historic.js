...
export const Historic = ({ first, second, value, color1, color2 }) => {
    return (
        <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginBottom: 20 }}>
            ...
            <View style={{ width: (CONST.screenWidth) / 3, flexDirection: 'row' }}>
                <Text style={[styles.cardMembersText, { fontWeight: '400' }]}>pagou<Text style={{ fontWeight: '600' }}> {value}</Text>€</Text>
            </View>
            <View style={{ width: (CONST.screenWidth) / 3, flexDirection: 'row' }}>
...
export const Payed = ({ first, second, value, color1, color2 }) => {
    return (
        <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginBottom: 20 }}>
            <View style={{ width: (CONST.screenWidth) / 3, flexDirection: 'row' }}>
                <Profile size="20" variant='Bold' color={color1} style={{ marginRight: 2 }} />
            ...
            <View style={{ width: (CONST.screenWidth) / 3, flexDirection: 'row' }}>
                <Text style={[styles.cardMembersText, { fontWeight: '400' }]}>recebeu<Text style={{ fontWeight: '600' }}> {value}</Text>€</Text>
            </View>
            <View style={{ width: (CONST.screenWidth) / 3, flexDirection: 'row' }}>
                <Profile size="20" variant='Bold' color={color2} style={{ marginRight: 2 }} />
                <Text style={styles.cardMembersText}>{second}</Text>
